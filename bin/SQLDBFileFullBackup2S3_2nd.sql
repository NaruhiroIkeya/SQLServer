...
SET @Counter=1;
SET @DATABASE_FILES = 'FILE=''' + @DATABASE + 'DATA3'', FILE=''' + @DATABASE + 'DATA4'', FILE=''' + @DATABASE + 'DATA7'', FILE=''' + @DATABASE + 'DATA8'', FILE=''' + @DATABASE + 'DATA11'', FILE=''' + @DATABASE + 'DATA12'', FILE=''' + @DATABASE + 'DATA15'', FILE=''' + @DATABASE + 'DATA16'''
