...
DECLARE @BACKUP_URL VARCHAR(128) = $(S3bucket) + @HOSTNAME + '_' + @DATABASE + '_DIFF_' + @StringDate;
DECLARE @Counter INT;
...
END
SET @EXEC_SQL = @EXEC_SQL + ' WITH DIFFERENTIAL, FORMAT, MAXTRANSFERSIZE = 20971520, COMPRESSION, STATS = 10;';
